import { Artist, db, Event } from '@festivapp/persistence';
...
export default async function ({ params, searchParams }: PageProps<'/festivals/[festivalId]/timetables'>) {
    ...
    return (
      <div className="row min-h-32 items-center justify-center">
        <p className="text-dim">
          You don't have any location yet. Start by creating one <Link href={`/festivals/${festivalId}/map`}>here</Link>
          .
        </p>
      </div>
    );
